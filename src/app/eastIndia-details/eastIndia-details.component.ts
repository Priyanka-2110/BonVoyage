...
@Component({
  selector: 'app-eastIndia-details',
  templateUrl: './eastIndia-details.component.html',
  styleUrls: ['./eastIndia-details.component.css']
})
export class EastIndiaDetailsComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    packageId && this.packageService.getEastPackage(packageId).subscribe((result)=>{
