...
@Component({
  selector: 'app-update-EastGallery',
  templateUrl: './update-EastGallery.component.html',
  styleUrls: ['./update-EastGallery.component.css']
})
export class UpdateEastGalleryComponent implements OnInit {
