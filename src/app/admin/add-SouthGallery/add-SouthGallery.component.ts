...
@Component({
  selector: 'app-add-SouthGallery',
  templateUrl: './add-SouthGallery.component.html',
  styleUrls: ['./add-SouthGallery.component.css']
})
export class AddSouthGalleryComponent implements OnInit {
  ...
  submit(data: IPackage){
    ...
    this.packageService.addSouthGallery(data).subscribe((result)=>{
      console.log(result)
      if(result){
