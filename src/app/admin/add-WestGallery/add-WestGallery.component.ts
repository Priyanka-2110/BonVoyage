...
@Component({
  selector: 'app-add-WestGallery',
  templateUrl: './add-WestGallery.component.html',
  styleUrls: ['./add-WestGallery.component.css']
})
export class AddWestGalleryComponent implements OnInit {
  ...
  submit(data: IPackage){
    ...
    this.packageService.addWestGallery(data).subscribe((result)=>{
      console.log(result)
      if(result){
