...
@Component({
  selector: 'app-southIndia-details',
  templateUrl: './southIndia-details.component.html',
  styleUrls: ['./southIndia-details.component.css']
})
export class SouthIndiaDetailsComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    packageId && this.packageService.getSouthPackage(packageId).subscribe((result)=>{
